...
const jobOpenings = {
    "Engineering": [
        { title: "Senior AI/ML Engineer", location: "Hyderabad (Hybrid)", type: "Full-time" },
        { title: "Frontend Developer (React)", location: "Remote", type: "Full-time" },
    ],
    "Academics & Mentorship": [
        { title: "Lead Data Science Instructor", location: "Hyderabad (On-site)", type: "Full-time" },
        { title: "Cybersecurity Mentor (Part-time)", location: "Remote", type: "Contract" },
    ],
     "Marketing & Sales": [
        { title: "Digital Marketing Manager", location: "Hyderabad", type: "Full-time" },
    ],
}

const benefits = [
    { icon: <Briefcase className="h-8 w-8 text-primary" />, title: "Growth Opportunities", description: "Fast-track your career with immense learning and leadership roles." },
    { icon: <Users className="h-8 w-8 text-primary" />, title: "Vibrant Culture", description: "Join a passionate team that loves to innovate and collaborate." },
    { icon: <Code className="h-8 w-8 text-primary" />, title: "Impactful Work", description: "Your work directly empowers thousands of learners to achieve their dreams." },
    { icon: <Megaphone className="h-8 w-8 text-primary" />, title: "Great Benefits", description: "Competitive salary, health insurance, and flexible work policies." },
]
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
            <div className="mb-12 text-center">
                <h2 className="text-3xl font-bold">Why Work at Quantum Leap Academy?</h2>
                ...
                {Object.entries(jobOpenings).map(([department, jobs]) => (
                    <div key={department}>
                        ...
                        <div className="space-y-4">
                            {jobs.map(job => (
                                <Card key={job.title} className="group transition-shadow hover:shadow-lg">
